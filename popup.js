        ...
        fetch("https://api-ma.enfarm.com/api/v1/ma/get-install-locations", {
            ...
            .then((data) => {
                ...
                const filteredLocations = data.content.filter((location) => {
                    return !/toàn|test|enfarm|koko/i.test(location.farmname) && farmIds.includes(location.farmid);
                });
               ...
               var marker = L.marker([location.lat, location.long], {
                   ...
                   farmType: farmDetails ? (farmDetails.cultivates[0].tree_type === 0 ? 'Coffee' : 'Durian') : 'Unknown'
               });*/
...
`;
                ...
                `;
                            ...
                            function createPopupContent(index, cultivateContents, farmDetails, location, randomImage) {
                                let content = `
                                <div style="position: relative; padding: 0; margin: 0;">
                                    <div style="overflow: hidden; width: 330px; height: 150px; position: relative; margin-left: -7.5%; margin-top: -15px; border-top-left-radius: 6px; border-top-right-radius: 6px;" onmouseover="this.querySelector('.parallax-img').style.transform = 'scale(1.1)'" onmouseout="this.querySelector('.parallax-img').style.transform = 'scale(1)'">
                                        <img src="${randomImage}" alt="Farm Image" style="width: 330px; height: 150px; position: absolute; top: 0; left: 0; transition: transform 0.3s ease;" class="parallax-img" />
                                    ...
                                    content += `
                                        <div id="cultivate-info" style="display: flex; align-items: center; margin-top: 10px;">
                                            ...
                                            <span id="cultivate-count" style="display: flex; align-items: center; margin-left: 10px; font-size: 12px; color: #808080;">
                                                ...
                                                ${index + 1} out of ${cultivateContents.length}
                                            </span>
                                        </div>
                                    `;
                                }
    ...
    .then((cultivateContents) => {
        ...
        popupContent = createPopupContent(0, cultivateContents, farmDetails, location, randomImage);
        ...
        marker.on("popupopen", function () {
            ...
            function updatePopupContent() {
                ...
                const newContent = createPopupContent(currentCultivateIndex, cultivateContents, farmDetails, location, randomImage);
    ...
    .finally(() => {
        let farmsNeedingAttentionCount = farmsNeedingAttention.size;
        ...
        document.getElementById("expectedProductivitySum").innerText = totalExpectedProd.toFixed(2);
                ...
                const coffeeIcon = createIcon("https://i.ibb.co/L6cGsSX/bean-shadow.png", [40, 40], [-30, -40]);
                ...
                function applyFilters() {
                    ...
                    originalMarkers.eachLayer(function (marker) {
                        ...
                        if (shouldInclude) {
                            let iconUrl = "https://i.ibb.co/bWhk7NN/gps-shadow.png";
                ...
                toggleFarms(durianButton, "Durian", "https://i.ibb.co/nnrMSMd/durian-removebg-preview.png", "active-durian");
                toggleFarms(coffeeButton, "Coffee", "https://i.ibb.co/L6cGsSX/bean-shadow.png", "active-coffee");
                toggleFarms(pepperButton, "Pepper", "https://i.ibb.co/WxVZrLN/icons8-pepper-96.png", "active-pepper");
                toggleFarms(teaButton, "Tea", "https://i.ibb.co/RCnz5gb/icons8-tea-leaves-64.png", "active-tea");
