...
function createOrUpdateGaugeCharts(latestNpkValue,latestMoistValue,latestPHValue,latestTempValue){const npkMaxValue=3;const npkThresholds=[0.5,1];const latestNpkRatio=latestNpkValue===null?0:latestNpkValue/300;if(npkGauge){npkGauge.data.datasets[0].needleValue=latestNpkRatio;npkGauge.options.plugins.gaugeValue=latestNpkRatio;npkGauge.update()}else{npkGauge=setupGaugeChart("npkGauge","NPK",npkThresholds,latestNpkRatio,0,npkMaxValue,{colors:["#BA0F30","#18A558","#BA0F30"],thresholdLabels:["Insufficient","Adequate","Excess"]})}
...
let headerContentNPK=`
            ...
            <!--<span style="color: rgba(255, 99, 132, 1); font-size: 8px;" data-translate="latest measure">(latest measure)</span>-->
          `;if(indicatorNPK!==""){headerContentNPK+=`&nbsp;&nbsp;${indicatorNPK}`}
document.querySelector(".headerNPK .title").innerHTML=headerContentNPK;let nutrientStatus="";let nutrientIcon="";let nutrientColor="";if(latestNpkValue===null){nutrientStatus='<span data-translate="No data">Không có dữ liệu</span>';nutrientIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">info</span>';nutrientColor="#888888"}else{if(nutrientRatio<0.5){nutrientStatus='<span data-translate="Insufficient Nutrients">Thiếu dinh dưỡng</span>';nutrientIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';nutrientColor="#BA0F30"}else if(nutrientRatio<=0.75){nutrientStatus='<span data-translate="Average Nutrients">Dinh dưỡng trung bình</span>';nutrientIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">check</span>';nutrientColor="#18A558"}else if(nutrientRatio<=1){nutrientStatus='<span data-translate="Adequate Nutrients">Đủ dinh dưỡng</span>';nutrientIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">done_all</span>';nutrientColor="#18A558"}else{nutrientStatus='<span data-translate="Excess Nutrients">Thừa dinh dưỡng</span>';nutrientIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';nutrientColor="#BA0F30"}}
...
let moistureStatus="";let moistureIcon="";let moistureColor="";if(latestMoistValue===null){moistureStatus='<span data-translate="No data">Không có dữ liệu</span>';moistureIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">info</span>';moistureColor="#888888"}else{if(latestMoistValue<22.5){moistureStatus='<span data-translate="Very dry">Rất khô</span>';moistureIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';moistureColor="#BA0F30"}else if(latestMoistValue<=35){moistureStatus='<span data-translate="Lack of water">Thiếu nước</span>';moistureIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';moistureColor="#BA0F30"}else if(latestMoistValue<=55){moistureStatus='<span data-translate="Enough moisture">Đủ ẩm</span>';moistureIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">done_all</span>';moistureColor="#18A558"}else{moistureStatus='<span data-translate="Excess water">Thừa nước</span>';moistureIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';moistureColor="#BA0F30"}}
...
document.querySelector(".headerpH .title").innerHTML=headerContentPH;let pHStatus="";let pHIcon="";let pHColor="";if(latestPHValue===null){pHStatus='<span data-translate="No data">Không có dữ liệu</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">info</span>';pHColor="#888888"}else{if(latestPHValue===7){pHStatus='<span data-translate="Neutral">Trung tính</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">done_all</span>';pHColor="#18A558"}else if(latestPHValue<4){pHStatus='<span data-translate="Very Acidic">Rất axit</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}else if(latestPHValue>=4&&latestPHValue<=4.5){pHStatus='<span data-translate="Acidic">Axit</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}else if(latestPHValue>4.5&&latestPHValue<7){pHStatus='<span data-translate="Slightly Acidic">Hơi axit</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}else if(latestPHValue>7&&latestPHValue<8){pHStatus='<span data-translate="Slightly Alkaline">Hơi kiềm</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}else if(latestPHValue===8){pHStatus='<span data-translate="Alkaline">Kiềm</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}else if(latestPHValue>8){pHStatus='<span data-translate="Very Alkaline">Rất kiềm</span>';pHIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';pHColor="#BA0F30"}}
...
document.querySelector(".headerTemp .title").innerHTML=headerContentTemp;let tempStatus="";let tempIcon="";let tempColor="";if(latestTempValue===null){tempStatus='<span data-translate="No data">Không có dữ liệu</span>';tempIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">info</span>';tempColor="#888888"}else{if(latestTempValue>=20&&latestTempValue<=30){tempStatus='<span data-translate="Average Temp">Nhiệt độ trung bình</span>';tempIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">done_all</span>';tempColor="#18A558"}else if(latestTempValue<20){tempStatus='<span data-translate="Low Temp">Nhiệt độ thấp</span>';tempIcon='<span class="material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';tempColor="#BA0F30"}else{tempStatus='<span data-translate="High Temp">Nhiệt độ cao</span>';tempIcon='<span class-"material-symbols-outlined" style="color: white; font-size: 1rem; margin-top: 2px;">warning</span>';tempColor="#BA0F30"}}
