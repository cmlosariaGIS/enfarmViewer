        ...
        <div class="farm-item" data-farm-name="${farm.farm_name}">
            ...
            <div class="farm-details">
                <div class="farm-title">
                    ${farm.farm_name}
                    ${needsAttention ? `<div class="needs-attention-glow"><div class="tooltip-right">This farm needs attention</div></div>` : `<div class="dont-need-attention"><div class="tooltip-right">This farm's soil status is ok</div>
                        </div>
                    `}
                </div>
